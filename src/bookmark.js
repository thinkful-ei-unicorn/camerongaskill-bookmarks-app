...
const generateMain = () => {
 ...
 <section>
    <div class ="container">
            ...
            <button type = "button" id ="create-button">Create a Bookmark</button><br>
    ...
    <form id="createBookmark">
        <div class ="hidden">
            ...
            <input type ="text" id="link" minlength = "5" pattern = "https?://.+" placeholder ="Please put in https format" required><br><br>
...
<div class="dropdown container">
     <p>Filter Bookmarks By Minimum Star rating:</p>
...
const generateBookmarkElement = (bookmark) => {
	let bookmarkItem = `<div class ="container js-bookmark-item" data-item-id="${
		bookmark.id
	}" tabindex="0">    
    ...
    <div ${bookmark.expanded === true ? "" : "style = 'display: none'"}>  
      <ul class = 'bookmark-item-expanded' style='list-style-type:none'>
        ...
        <li class = "bookmarkInfo"><a href="${
					bookmark.url
				}" target = "_blank">${bookmark.url}</a></li>
...
const generateBookmarkString = (bookmark) => {
